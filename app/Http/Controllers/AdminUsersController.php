...
class AdminUsersController extends Controller {
    ...
    public function postAddSave() {
        try {
            ...
            return cb()->redirect(route("AdminUsersControllerGetIndex"),"New user has been created!","success");
    ...
    public function postEditSave($id) {
        try {
            ...
            return cb()->redirect(route("AdminUsersControllerGetIndex"),"The user has been updated!","success");
