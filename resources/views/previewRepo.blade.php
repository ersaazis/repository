...
<div class="row">
    <div class="col-12">
        <iframe style="height:100vh; width:100%; border:none; margin:0; padding:0; overflow:hidden;" src="https://docs.google.com/viewer?url={{url()->current()}}&hl=en&pid=explorer&efh=false&a=v&chrome=false&embedded=true"></iframe>
    </div>
    <div class="col-12">
